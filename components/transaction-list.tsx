...
export function TransactionList({ onEditTransaction }: TransactionListProps) {
  ...
  const sortedMonths = Object.keys(groupedTransactions).sort((a, b) => {
    const [monthNameA, yearA] = a.toLowerCase().split(" de ") as [
      MonthName,
      string
    ];
    const [monthNameB, yearB] = b.toLowerCase().split(" de ") as [
      MonthName,
      string
    ];
  ...
  const { totalIncome, totalExpense }: { totalIncome: number; totalExpense: number } =
    transactions.reduce(
      (acc, t) => {
        if (t.type == "expense") {
                    ...
                    <div className="space-y-4">
                      {groupedTransactions[monthYear]
                        ...
                        .map((transaction) => (
                          ...
                          >
                            <div className="flex-grow flex items-center gap-2 mb-2 sm:mb-0">
                              <div
